                ...
                <div class="rounded-full h-full w-40 md:w-24 overflow-hidden my-6">
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-x-12">
                        <div class="div py-2 md:py-0 w-full md:w-auto">
                            <a href="" class="text-primary-500 hover:text-white text-lg md:text-2xl mt-3 w-full md:w-auto border-2 border-primary-500  hover:border-primary-500 hover:bg-primary-500  rounded-md font-medium py-2 px-10">I work with</a>
                        </div>
                        <div class="div py-2 md:py-0 w-full md:w-auto">
                            <a href="" class="text-white text-lg md:text-2xl mt-3 w-full md:w-auto border-2 border-primary-500 hover:border-primary-500 bg-primary-500 hover:bg-primary-500 rounded-md font-medium py-2 px-10"> Work with me</a>
                        </div>
                    </div>
            </div>
        </div>
