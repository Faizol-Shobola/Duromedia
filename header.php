...
<header >
  ...
  <div class="mobile-menu top-20 inset-x-0 transition hidden transform origin-top-right md:hidden fixed z-10">
    <div class="min-h-screen shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
      <div class="pt-5 pb-6 px-5">
        <div class="flex items-center justify-between pr-5 none hidden">
          <div>
            <?php 
              if ( function_exists( 'the_custom_logo' ) ) {
                the_custom_logo();
          ...
          <div class="-mr-2">
            <button type="button" class="close_link-toggle bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
